                ...
                <div class="card-body pt-3">
                    <div class="tab-content pt-2">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#addInfos">Remplir
                                    les informations</button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#confirmInfos">Confirmer
                                    les informations</button>
                            </li>

                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#addCarte">Attribuer
                                    une carte</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                                    ...
                                    <form action="#" method="post" id="account-form">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <div class="square overflow-hiddden"
                                                    ...
                                                    <img src="../assets/img/blank_image.jpg"
                                                        class="img-fluid h-100 w-100" id="imgPreview">
                                                </div>
                                                <div class="pt-2">
                                                    <input type="file" name="imgMutualiste" id="imgMutualiste"
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Sexe
                                                :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <select name="sexe" type="text" class="form-control"
                                                    id="sexe" onchange="updatePhonePrefix()" required>
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Pays de
                                                résidence:</label>
                                            <div class="col-md-8 col-lg-9">
                                                <select name="pays" type="text" class="form-control"
                                                    id="pays" onchange="updatePhonePrefix()" required>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="dateNaissance" type="date" class="form-control"
                                                    id="dateNaissance" value="Kevin Anderson" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="lieuNaissance" type="text" class="form-control"
                                                    id="lieuNaissance"
                                                    placeholder="Entrez le lieu de naissance du mutualiste" required>
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Profession
                                                :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="profession" type="text" class="form-control"
                                                    id="profession" placeholder="Entrez la profession du mutualiste"
                                                    required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Lieu de
                                                résidence :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="lieuResidence" type="text" class="form-control"
                                                    id="lieuResidence"
                                                    placeholder="Entrez le lieu de résidence du mutualiste" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Point
                                                de repère :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="repère" type="text" class="form-control"
                                                    id="repère"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <select name="typtPiece" type="text" class="form-control"
                                                    id="typePiece" required>
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-3 col-lg-3 col-form-label">N°
                                                pièce d'identification :</label>
                                            <div class="col-md-9 col-lg-9">
                                                <input name="numeroPiece" type="text" class="form-control"
                                                    id="numeroPiece" type="number"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="dateDelivrancePiece" type="date" class="form-control"
                                                    id="dateDelivrancePiece" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Lieu de
                                                délivrance pièce d'identification :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="lieuDelivrancePiece" type="text" class="form-control"
                                                    id="lieuResidencePiece"
                                                    placeholder="Entrez le lieu de délivrance de la pièce d'identification"
                                                    required>
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Situation
                                                matrimoniale
                                                :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <select name="situationMatrimoniale" type="text"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="beneficiaireDécès" type="text" class="form-control"
                                                    id="beneficiaireDécès"
                                                    placeholder="Entez le nom du bénéficiare en cas de décès" required>
                                            </div>
                                        </div>

                                        <div class="row mb-3">
                                            <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Noms
                                                des assurés secondaires :</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="nomAssuré1" type="text" class="form-control"
                                                    id="nomAssuré1"
                                                    placeholder="Entrez le nom de l\'assuré secondaire N°1" required>
                                                <br>
                                                <div id="input-container" style="margin-top: 8px;"></div>
                                                <div class="icon" style="margin-top: 15px;">
                                                    <i class="bi bi-plus-circle-fill text-success add-input"
                                                        style="cursor: pointer;">Ajouter</i>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane fade profile-overview pt-3" id="confirmInfos">
                                ...
                                <div class="" style="font-weight: bold; color: gray;">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <div class="square overflow-hiddden" style="width: 115px; height:115px;">
                                                <img src="../assets/img/blank_image.jpg" class="img-fluid h-100 w-100"
                                                    id="imgPreview">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="label ">Nom : <label for="" class="text-dark">Kevin
                                                Anderson</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Prenom : <label for=""
                                                class="text-dark">Franck</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Sexe : <label for=""
                                                class="text-dark">Masculin</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Pays de résidence : <label for=""
                                                class="text-dark">Cameroun</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Numero de téléphone : <label for=""
                                                class="text-dark">+237 652337362</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Date de naissance : <label for=""
                                                class="text-dark">14/08/2024</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Lieu de naissance : <label for=""
                                                class="text-dark">Yaoundé</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Profession : <label for=""
                                                class="text-dark">Vendeur</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Lieu de résidence : <label for=""
                                                class="text-dark">Colombia</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Point de repère : <label for=""
                                                class="text-dark">Boutique Orange</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Type de pièce d'identification : <label for=""
                                                class="text-dark">CNI</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">N° pièce d'identification : <label for=""
                                                class="text-dark">25658988745</label></div>
                                    </div>

                                    <div class="row">
                                        <div class=" label">Date de délivrance pièce d'identification : <label
                                                for="" class="text-dark">18/04/2020</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Lieu de délivrance : <label for=""
                                                class="text-dark">CDE-06</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Situation Matrimoniale : <label for=""
                                                class="text-dark">Célibataire</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Nom du bénéficiaire en cas de décès : <label
                                                for="" class="text-dark">Bénéficiaire</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°1 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°2 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°3 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°4 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°5 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°6 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°7 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°8 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°9 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>

                                    <div class="row">
                                        <div class="label">Assuré secondaire N°10 : <label for=""
                                                class="text-dark">Assuré 1</label></div>
                                    </div>
                                    ...
                                    <form action="#" method="post" id="account-form">
                                        ...
                                        <div class="centered-div ">
                                            ...
                                            <h1 class="fw-bold text-black">
                                                <center>APPROCHEZ LA CARTE DU MUTUALISTE POUR CREER SON COMPTE
                                                </center>
                                            </h1>
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control visually-hidden"
                                                    id="floatingInput" placeholder="Password" name="id_carte"
                                                    autofocus>
                                            </div>
                                            <hr class="my-3">
